...
hf_help_topic_en() {
  ...
  case "$t" in
    ...
    remote|rc|control)
      ...
      ;;
    *)
      hf_err "No help for '$t'. Topics: tools · agent · new · resume · remote · worker · fix · tickets · intake · eval · review · deploy · swarm · llm · lang"
      ;;
  esac
}
...
hf_help_topic_es() {
  ...
  case "$t" in
    ...
    remote|rc|control)
      ...
      ;;
    *)
      hf_err "No hay ayuda para '$t'. Temas: tools · agent · new · resume · remote · worker · fix · tickets · intake · eval · review · deploy · swarm · llm · lang"
      ;;
  esac
}
